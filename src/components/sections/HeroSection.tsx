        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Upload prescriptions, lab results, and medical reports to get instant AI-powered analysis, 
                risk assessments, and personalized health insights you can understand.
              </p>
            </div>
          ...
          >
            ...
            <div className="relative card-medical-glow backdrop-blur-2xl shadow-medical">
              {/* Doctor Image */}
              <div className="absolute -top-8 -right-8 w-32 h-32 rounded-2xl overflow-hidden shadow-accent border-2 border-primary/30 animate-float">
                <img 
                  src={doctorHero} 
                  alt="Professional doctor analyzing medical documents" 
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-bold text-foreground">AI Medical Analysis</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-muted/50 backdrop-blur-sm rounded-xl p-5 border border-warning/20">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm font-semibold text-foreground">Cholesterol</span>
                  ...
                  <div className="bg-muted/50 backdrop-blur-sm rounded-xl p-5 border border-primary/20">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-sm font-mono text-primary-glow font-bold">85/100</span>
                    </div>
                    <div className="w-full bg-secondary/50 rounded-full h-3">
                      <motion.div 
                        initial={{ width: 0 }}
              ...
              <motion.div
                ...
                className="absolute -bottom-12 -right-12 w-28 h-28 rounded-xl overflow-hidden shadow-card border border-border animate-bounce-subtle"
              >
                <img 
                  src={patientCare} 
                  alt="Happy patient receiving medical consultation" 
                  className="w-full h-full object-cover"
                />
              </motion.div>
            </div>
